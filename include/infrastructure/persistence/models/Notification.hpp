...
class Notification
{
  public:
    struct Cols
    {
        ...
        static const std::string _leave_request_id;
     ...
     */
    explicit Notification(const Json::Value &pJson) noexcept(false);
     ...
     */
    Notification(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column leave_request_id  */
    ///Get the value of the column leave_request_id, returns the default value if the column is null
    const std::string &getValueOfLeaveRequestId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getLeaveRequestId() const noexcept;
    ///Set the value of the column leave_request_id
    void setLeaveRequestId(const std::string &pLeaveRequestId) noexcept;
    void setLeaveRequestId(std::string &&pLeaveRequestId) noexcept;
    void setLeaveRequestIdToNull() noexcept;
    ...
    LeaveRequest getLeaveRequest(const drogon::orm::DbClientPtr &clientPtr) const;
    void getLeaveRequest(const drogon::orm::DbClientPtr &clientPtr,
  ...
  private:
    ...
    std::shared_ptr<std::string> leaveRequestId_;
